...
class MainGlobal extends AbstractForm
{
    ...
    {    
        ...
        $thread_getGames = new Thread(function (){
            try {
                $_serverData = file_get_contents('http://acwh.zzz.com.ua/sunate/'.$this->date->value.'.txt');
                ...
                try {
                    ...
                    if (str::length($_serverDataRanks) > 500){
                        ...
                        uiLater(function () use ($_serverDataRanksArray){
                            $this->player_wins->text = $_serverDataRanksArray[0].' из '.$_serverDataRanksArray[2].' / '.$_serverDataRanksArray[1].' из '.$_serverDataRanksArray[3];
